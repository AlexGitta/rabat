  ...
  days: [
    {
      ...
      items: [
        ...
        { time: '7:30–9:00',  activity: 'Dinner at Sufra',         detail: '19 Av. Moulay Rachid. Palestinian – falafel and knafeh for dessert. Small place, book ahead. The owners speak English.', imageKey: 'sufra' },
        { time: '9:00–11:00', activity: 'Evening Walk',            detail: 'Stroll the buzzing medina. Try mint tea, chebakia, msemen from street stalls.', imageKey: 'medina' }
      ],
    },
    {
      day: 2,
      ...
      items: [
        ...
        { time: '10:30–12:30', activity: 'Chellah',                   detail: 'Roman ruins from 40 AD layered with a 14th-century Islamic necropolis, overgrown gardens, nesting storks. Audio guide recommended. Entry ~70 MAD.', imageKey: 'chellah' },
        { time: '12:30–2:00',  activity: 'Hassan Tower & Mausoleum',  detail: 'Unfinished 12th-century minaret with 200 stone columns. Next door: Mausoleum of Mohammed V – tilework and gilded ceiling. Free entry.', imageKey: 'hassan-tower' },
        { time: '2:00–4:00',   activity: 'Lunch & Rest',              detail: 'Back home. Have lunch. Recharge.' },
        { time: '4:30–6:30',   activity: 'Medina & Souks',            detail: 'Browse Rue des Consuls for cool stuff.' },
        { time: '~6:45pm',     activity: 'Iftar',                     detail: 'Call to prayer.' },
        { time: '7:30–9:30',   activity: 'Dinner at Kasr Al Assil',   detail: '39 Rue Youssef Ibn Tachfine. Traditional Moroccan – Royal Tagine, rfissa with chicken, Jawhara dessert. Closed Sundays; couscous Fridays only (Can switch days).', imageKey: 'kasr' },
    ...
    },
    {
      ...
      items: [
        ...
        { time: '11:00–1:00',  activity: 'Kasbah des Oudayas',          detail: '12th-century fortress above the river mouth. Blue-and-white alleyways, Andalusian Gardens, views over the Atlantic and across to Salé. Walk down to the beach.', imageKey: 'kasbah' },
        { time: '1:00–2:30',   activity: 'Flouka to Salé',              detail: 'Take a rowing boat across the Bouregreg River to Salé – a few minutes on the water with views both ways. Just a few dirhams. Explore Salé medina.', imageKey: 'flouka' },
        { time: '2:30–4:30',   activity: 'Rest & Recharge',             detail: 'Tram back. Lunch at home.' },
        { time: '5:00–6:30',   activity: 'Mohammed VI Museum',          detail: 'Museum of Modern and Contemporary Art, 200+ modern Moroccan artists.', imageKey: 'museum' },
        { time: '~6:45pm',     activity: 'Iftar',                       detail: '' },
        { time: '7:30–9:30',   activity: 'Dinner at Zain Al Abdeen',    detail: 'Rue Souika, inside the medina. A local spot. Cheap and satisfying.' },
    ...
    },
    {
      ...
      items: [
        ...
        { time: '10:30–1:00',  activity: 'Villa des Arts',           detail: 'Art nouveau building with rotating contemporary art exhibitions. Peaceful gardens. Very cheap entry. Close to the Airbnb.', imageKey: 'villa' },
        { time: '1:00–3:00',   activity: 'Lunch & Relax',           detail: 'Pick up ingredients and cook something together at the Airbnb.' },
        { time: '3:00–5:30',   activity: 'Hammam at Dar El Kebira',  detail: 'A 17th-century riad in the medina offering a traditional hammam experience – steam, black soap scrub, and relaxation. Website: dar-el-kebira.com · Book in advance by email or phone – contact details on their website.' },
        { time: '7:30–9:30',   activity: 'Dinner at Dinarjat',      detail: "Hidden behind an unmarked heavy wooden door on Boulevard el Alou – a 17th-century riad. Live music in the courtyard, Moroccan cuisine (lamb tagine tfaya, veal jarret, pastilla). Book ahead – essential. ~300–400 MAD/pp.", imageKey: 'dinarjat' },
      ...
      return `
        <div class="event" onclick="toggleEvent(this)">
          ...
          <div class="event-body">
            <div class="event-body-inner">${imgHTML}${detailHTML}</div>
          </div>
        </div>`;
    }).join('');
